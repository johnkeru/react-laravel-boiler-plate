...
export default function Bath({setValue}) {
    ...
    const handleSet = () => {
        setValue(`maxBaths=${val}&`);
        handleClose();
    }

    return (
        <>
        <Button variant="outlined" onClick={handleClickOpen} size="small" sx={sx}>Bath</Button>

        <Dialog open={open} onClose={handleClose}>
            <DialogTitle>Bath</DialogTitle>
            <DialogContent>
